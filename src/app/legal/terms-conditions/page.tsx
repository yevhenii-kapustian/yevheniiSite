...
const TermsConditions = () => {
    return(
        <section className="pt-10 px-6 pb-16 flex flex-col gap-10">
            <h1 className={`${babes.className} text-3xl sm:text-4xl text-center`}>Terms and conditions</h1>
            <div className="mx-auto max-w-3xl w-full flex flex-col gap-8">
                <div>
                    <h3 className="pb-3 text-lg sm:text-xl font-semibold">Risk of product use</h3>
                ...
                <div className="border-t border-black/5 pt-8">
                    <h3 className="pb-3 text-lg sm:text-xl font-semibold">Generally expected results</h3>
                    <p className="text-sm sm:text-base text-ink-strong/80">
                ...
                <div className="border-t border-black/5 pt-8">
                    <h3 className="pb-3 text-lg sm:text-xl font-semibold">Testimonial disclaimer</h3>
                    <p className="text-sm sm:text-base text-ink-strong/80">
