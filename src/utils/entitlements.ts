...
export const upsellCopy = (state: ModuleState, periodEnd: string | null, neverPurchasedMessage: string) => {
    if (state === "lapsed") {
        ...
        return {
            ...
            buttonLabel: "Resubscribe — $45/mo",
        }
    }
    return { message: neverPurchasedMessage, buttonLabel: "Get full access — $45/mo" }
}
